...
const Blog = () => {
  return (
    <div class="mx-6">
      ...
      <p class="text-2xl">
        Ans: We can Improve the performance of a React Application serveral
        Ways-
      </p>
      <ul class="text-2xl">
      ...
      <p class="text-2xl">
        Ans: There are four main steps to manage state in a React Application
      </p>
      <ul class="text-2xl">
        <li>Local State</li>
        <li>Global State</li>
      ...
      <p class="text-2xl">
        Ans: Unit Testing is important because software developers sometimes try
